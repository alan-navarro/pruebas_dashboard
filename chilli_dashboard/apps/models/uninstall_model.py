...
class UninstallModel:
    ...
    def get_data(self,start_date,end_date):
        ...
        uninstalls_df = uninstalls_df.drop(columns = ["index"])
        uninstalls_df = uninstalls_df.rename(columns = {"('uninstalled', '', '')": 'event_date'})
        uninstalls_df.columns = [c.replace("('sum', 'uninstalls_count', '", "").replace("')", "") for c in uninstalls_df.columns]
        ...
        final_df_uninstalls = final_df_uninstalls.set_index("event_date")
